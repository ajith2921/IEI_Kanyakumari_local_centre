...
export default function About() {
  return (
    <section className="page-shell section-block">
      ...
      <div className="section-card mb-10 p-7 leading-relaxed text-slate-700 md:p-9">
        <p className="mb-4">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {highlights.map((item) => (
          <article key={item.title} className="section-card interactive-card p-6">
            <h3 className="mb-3 text-lg font-black text-brand-800">{item.title}</h3>
